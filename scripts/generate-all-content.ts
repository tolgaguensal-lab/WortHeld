...
const vocabularyByLevel: Record<CEFRLevel, VocabEntry[]> = {
  A1: [
    ...
    { word: "die Kinder", article: "die", plural: "Kinder", pos: "Nomen", gender: "NEUTER", translationEn: "children", translationTr: "çocuklar", exampleSentence: "Die Kinder spielen.", exampleTranslation: "The children are playing." },
