...
export const metadata: Metadata = {
  title: "Wortwende â€“ Deutsch lernen mit KI-Tutor Leo",
  description: "Lerne Deutsch von A1 bis C1 mit deinem persÃ¶nlichen KI-Tutor Leo. 24/7 verfÃ¼gbar, 10 Muttersprachen, BAMF-orientiert. Jetzt kostenlos starten.",
  openGraph: {
    title: "Wortwende â€“ Deutsch lernen mit KI-Tutor",
    description: "Dein persÃ¶nlicher KI-Tutor fÃ¼r Deutsch. 24/7. PersÃ¶nlich. Kostenlos starten.",
    type: "website",
  },
};

const tutorFeatures = [
  { icon: Brain, title: "KI-TUTOR 24/7", desc: "Dein persönlicher Deutsch-Lehrer â€“ jederzeit verfügbar, unendlich geduldig." },
  { icon: MessageSquare, title: "THEMEN-SESSIONS", desc: "Dativ? Perfekt? Wähle ein Thema â€“ der Tutor führt dich Schritt für Schritt." },
  { icon: Mic, title: "SPRECHEN & HÖREN", desc: "Sprich mit dem Tutor über dein Mikrofon â€“ er versteht dich und antwortet." },
  { icon: Globe, title: "10 MUTTERSPRACHEN", desc: "Lerne Deutsch aus deiner Sprache â€“ Türkisch, Arabisch, Russisch und mehr." },
];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <Animated type="fadeUp">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl mb-8 leading-relaxed">
              Lerne Deutsch im Gespräch mit einer KI, die dich versteht. Grammatik, Vokabeln, Aussprache â€“ dein Tutor erklärt, übt und korrigiert dich. In deiner Sprache.
            </p>
              ...
              <div className="w-72 h-96 rounded-[40px] bg-gradient-to-br from-primary to-primary-hover p-1 shadow-2xl shadow-primary/20">
                <div className="w-full h-full rounded-[36px] bg-card p-4 flex flex-col gap-3">
                  <div className="flex items-center gap-2 px-1">
                    ...
                    <div><div className="text-xs font-bold">Leo â€“ KI-Tutor</div><div className="text-[10px] text-muted-foreground">Online &middot; 24/7 verfÃ¼gbar</div></div>
                  </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        ...
        <Stagger className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          {[
            { step: "1", icon: Globe, title: "Sprache wählen", desc: "Türkisch, Arabisch, Russisch â€“ lerne Deutsch aus deiner Muttersprache." },
            { step: "2", icon: Bot, title: "Thema aussuchen", desc: "Dativ, Perfekt, Bewerbung â€“ der Tutor passt sich deinem Niveau an." },
            { step: "3", icon: MessageSquare, title: "Loslegen", desc: "Sprich oder tippe â€“ der Tutor erklärt, übt und korrigiert live." },
          ].map((s) => (
      ...
      <section className="bg-card-highlight py-24">
        <div className="max-w-7xl mx-auto px-6">
          <Animated type="fadeUp" className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">Vom ersten Wort zur selbstbewussten Kommunikation â€“ mit deinem KI-Tutor an der Seite.</p>
          </Animated>
      ...
      <section className="bg-primary py-24">
        <Animated type="scaleIn" className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-white/60 max-w-md mx-auto mb-8 text-lg">Starte jetzt â€“ dein Deutsch-Tutor wartet schon auf dich.</p>
