    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-4">
          {[
            { q: "Warum ist Wortwende so g&uuml;nstig?", a: "Wir nutzen DeepSeek V4 Flash – eines der günstigsten und leistungsfähigsten KI-Modelle der Welt (20x günstiger als GPT-4). Eigene Server (ZimaOS), Open-Source-Tools. Keine Investoren, keine Marketing-Budgets." },
