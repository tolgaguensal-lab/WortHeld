    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6 text-muted-foreground">
          ...
          <p>Diese AGB gelten für die Nutzung der Lernplattform DeutschQuest. Durch die Nutzung unserer Dienste erklären Sie sich mit diesen Bedingungen einverstanden.</p>

          <h2 className="text-xl font-display font-semibold text-foreground">§ 2 Leistungsbeschreibung</h2>
          <p>DeutschQuest bietet eine interaktive Lernplattform zum Erlernen der deutschen Sprache von Niveau A1 bis C1. Der Service umfasst Lektionen, Übungen, Vokabeltrainer und Fortschrittsverfolgung.</p>
