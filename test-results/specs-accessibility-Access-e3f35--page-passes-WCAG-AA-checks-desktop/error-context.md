...
- Name: specs/accessibility.spec.ts >> Accessibility + WCAG AA >> [A11Y] Onboarding page passes WCAG AA checks
...
- generic [active] [ref=e1]:
  - generic [ref=e9]:
    - img [ref=e11]
    - heading "Willkommen bei WortHeld" [level=1] [ref=e15]
    - paragraph [ref=e16]: Wahle deine Muttersprache fur Hilfestellungen.
    - generic [ref=e17]:
      - button "🇬🇧 Englisch" [ref=e18] [cursor=pointer]:
        - generic [ref=e19]: 🇬🇧
        - text: Englisch
      - button "🇹🇷 Türkisch" [ref=e20] [cursor=pointer]:
        - generic [ref=e21]: 🇹🇷
        - text: Türkisch
      - button "🇷🇺 Russisch" [ref=e22] [cursor=pointer]:
        - generic [ref=e23]: 🇷🇺
        - text: Russisch
      - button "🇸🇦 Arabisch" [ref=e24] [cursor=pointer]:
        - generic [ref=e25]: 🇸🇦
        - text: Arabisch
      - button "🇵🇱 Polnisch" [ref=e26] [cursor=pointer]:
        - generic [ref=e27]: 🇵🇱
        - text: Polnisch
      - button "🇷🇴 Rumänisch" [ref=e28] [cursor=pointer]:
        - generic [ref=e29]: 🇷🇴
        - text: Rumänisch
      - button "🇺🇦 Ukrainisch" [ref=e30] [cursor=pointer]:
        - generic [ref=e31]: 🇺🇦
        - text: Ukrainisch
      - button "🇦🇱 Albanisch" [ref=e32] [cursor=pointer]:
        - generic [ref=e33]: 🇦🇱
        - text: Albanisch
      - button "🏳️ Kurdisch (Kurmandschi)" [ref=e34] [cursor=pointer]:
        - generic [ref=e35]: 🏳️
        - text: Kurdisch (Kurmandschi)
      - button "🇮🇹 Italienisch" [ref=e36] [cursor=pointer]:
        - generic [ref=e37]: 🇮🇹
        - text: Italienisch
    - button "Deutsch als Muttersprache" [ref=e38] [cursor=pointer]
  - alert [ref=e39]
```
