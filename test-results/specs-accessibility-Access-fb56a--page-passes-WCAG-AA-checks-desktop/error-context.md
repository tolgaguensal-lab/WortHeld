...
- Name: specs/accessibility.spec.ts >> Accessibility + WCAG AA >> [A11Y] Register page passes WCAG AA checks
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e8]:
      ...
      - generic [ref=e14]:
        - generic [ref=e15]:
          - heading "Konto erstellen" [level=3] [ref=e16]
          - paragraph [ref=e17]: Starte deine Deutsch-Lern-Reise
        - generic [ref=e19]:
          - generic [ref=e20]:
            - text: Name
            - generic [ref=e21]:
          ...
          - generic [ref=e42]:
            ...
            - generic [ref=e43]:
              - img [ref=e44]
              - textbox "Passwort wiederholen" [ref=e47]
          - button "Kostenlos starten" [ref=e48] [cursor=pointer]:
            - text: Kostenlos starten
            - img
        - paragraph [ref=e50]:
          - text: Bereits ein Konto?
          - link "Anmelden" [ref=e51] [cursor=pointer]:
            - /url: /login
  - alert [ref=e52]
```
